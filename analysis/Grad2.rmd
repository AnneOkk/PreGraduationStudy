...
t3wor ~ t1wor  + t1cplan_l

t3cplan_l ~ t1cplan_l   + t1wor

t1wor ~~ t1cplan_l 
t3wor ~~ t3cplan_l
'

fit_reci <- sem(direct_effects, data=df, estimator='mlr',missing='fiml') #If fixed.x=T TRUE, the exogenous `x' covariates are considered fixed variables and the means, variances and covariances of these variables are fixed to their sample values. If FALSE, they are considered random
summary(fit_reci, fit.measures=TRUE, standardized=TRUE, rsquare=TRUE)
modificationindices(fit_reci, sort = T)
